...
for index in range(0, len(dwtiles)):
    ...
    #tmxlib cheerfully loads tiles of transparent pixels as the empty set, so we need to get rid of those
...
# print len(tileset_number_to_tile_pixels.keys())
